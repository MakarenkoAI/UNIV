	...
	for el in data:
		...
		if el[1] == '!':
			...
			for el_ in range(len(first_list)):
				temp_answer.append(solve(int(first_list[el_]), '!'))
			answer.append(temp_answer)
		else:
			if equality_abc(el[1]):
			...
			for el_ in range(len(first_list)):
				temp_answer.append(solve(int(first_list[el_]), el[2], int(second_list[el_])))
			answer.append(temp_answer)
